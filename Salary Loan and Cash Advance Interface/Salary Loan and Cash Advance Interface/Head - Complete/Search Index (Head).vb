...
Public Class frm_HeadSI
    ...
    Private Sub btn_ProfileHome_Click(sender As Object, e As EventArgs) Handles btn_ProfileHome.Click
        ...
        Me.Close()
    End Sub
    Private Sub frm_HeadSI_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txt_EmpIDProf_TextChanged(sender As Object, e As EventArgs) Handles txt_EmpIDProf.TextChanged
        ...
        If txt_EmpIDProf.Text = "" Then
            txt_LName.Clear()
            txt_FName.Clear()
            txt_Job.Clear()
            txt_DeptName.Clear()
            txt_Salary.Clear()
            dgv_SalaryLoanProfile.DataSource = DBNull.Value
            dgv_CashAdvanceProfile.DataSource = DBNull.Value
        Else
            If txt_EmpIDProf.Text <> Nothing Then
                txt_LName.Clear()
                txt_FName.Clear()
                txt_Job.Clear()
                txt_DeptName.Clear()
